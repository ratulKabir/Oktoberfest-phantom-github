...
def sample_test(model_rnn, codebook, codes, chunk_len, seqlen, batch_size):
    '''
...
def generate_rnn(model_rnn, codebook, seqlen, batch_size):
    '''
    Params: model_rnn: The thrained rnn model model (LSTM in this case)
            seqlen: expected length of the generated sequence
            batch_size: batch size
...
def generate_audio(model_rnn, codebook, seqlen, batch_size=32):
    '''
    Params: model_rnn: The thrained rnn model model (LSTM in this case)
            seqlen: expected length of the generated sequence
            codes: code sequence from training data
    ...
    '''
    fs, ld, z = generate_rnn(model_rnn, codebook, seqlen, batch_size)
...
def generate_sample_test(model_rnn, codebook, code, chunk_len=1, seqlen=1, batch_size=32):
    '''
    Params: model_rnn: The thrained rnn model model (LSTM in this case)
            codes: code sequence from training data
            chunk_len: length of the chunk from code that is used as the seed of the generated sequence
    ...
    Output: outputs generated audio of seqlen*4 seconds
    '''
    fs, ld, z = sample_test(model_rnn, codebook, code, chunk_len, seqlen, batch_size)
    fh = f0_scaleds_to_f0_hzs(fs)
